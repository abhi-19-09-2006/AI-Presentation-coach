...
 - - - )  
 s t . m a r k d o w n (  
         f " =���  * * F a c e   E m o t i o n   A n a l y s i s * *   |   =���  * * P e r f o r m a n c e   T r a c k i n g * *   |   <د�  * * C o n t e x t - S p e c i f i c   C o a c h i n g * *   |   "  
         f " �&  * * R e a l - t i m e   F e e d b a c k * *   |   =���  * * A d v a n c e d   A n a l y t i c s * *   |   * * C u r r e n t :   { t h e m e } * * "  
 